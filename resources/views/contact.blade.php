                                ...
                                <div class="col-12">
                                    <div class="form-group" dir="rtl">
                                        ...
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9"
                                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder='پیام خود را وارد کنید'></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control" name="email" id="email" type="email"
                                            ...
                                            onblur="this.placeholder = 'Enter email address'" placeholder='ایمیل'>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>ایران، خوزستان اندیمشک.</h3>
                                <p> خیابان سلمان فارسی</p>
                            </div>
                        </div>
                        <div class="media contact-info">
