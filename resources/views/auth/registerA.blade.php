<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Email Address -->
        <div class="mt-4">
            <x-input-label for="email" :value="__('رایانامه')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('کلمه عبور')" />
         ...
         <div>
            ...
            <select name="role" id="role" class="block mt-1 w-full" :value="old('role')" required autofocus autocomplete="role">
