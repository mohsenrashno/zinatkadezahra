...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_bootstrap4-rtl.min.css') }}">
    <!-- animate CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_animate.css') }}">
    <!-- owl carousel CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_owl.carousel.min.css') }}">
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_all.css') }}">
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('css/single_product_themify-icons.css') }}">
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_magnific-popup.css') }}">
    <!-- swiper CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_slick.css') }}">
    <!-- style CSS -->
    <link rel="stylesheet" href="{{ asset('css/single_product_style.css') }}">
</head>
...
<body class="rtl">
    ...
    <header class="main_menu home_menu">
        ...
        <!-- breadcrumb part end-->
        <img src="{{ asset('img/product/single_product/' . $product->name . '.png') }}"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8">
                        <div class="single_product_text text-center">
                            ...
                            <p>
                                @php
                                    $filename = './description/' . $product->name . '.txt';
                                    $f = fopen($filename, 'r');
                            ...
                            <form method=GET
                                Action="{{ URL::route('order', ['productname' => $product->name]) }}">
                                ...
                                <div class="card_area">
                                    ...
                                    <div class="add_to_cart">
                                        ...
                                        @if ($is_customer == true)
                                            <button class="btn_3" type="submit">  افزودن به سبد خرید</button>
                                            {{-- <a href="{{ route('order', ['id' => $id, 'productname' => $product->name]) }}"
                                                class="btn_3">
                                                <p>افزودن به سبد</p>
                                            </a> --}}
                                        @else
                                            <p> برای افزودن به سبد خرید وارد شوید. </p>
                                        @endif
